      ...
      <div className="min-h-screen bg-[#1E2430] flex font-sans">
        ...
        <div className="flex-1 flex flex-col min-w-0">
          <TopBar 
            ...
            subtitle="Track your active offers and real-time deal discussions"
            showSearch={false}
          />
          
          <main className="flex-1 p-6 lg:p-10 lg:ml-64 overflow-y-auto">
            <div className="flex items-center justify-between mb-8">
              <h2 className="text-2xl font-bold text-white">Active Deal Rooms</h2>
            </div>
            ...
            {loading ? (
                      ...
                      <div className="flex items-center">
                        ...
                        <div>
                          ...
                          <p className="text-sm text-[#C8C5C7]">
                            Latest Offer: <span className="font-bold text-white">₹{deal.currentOffer?.toLocaleString()}</span>
                          </p>
                        </div>
                      </div>
              ...
              <div className="text-center py-20 bg-[#322D40] rounded-3xl border border-[#1E2430] max-w-3xl mx-auto flex flex-col items-center mt-12 shadow-lg">
                ...
                <p className="text-[#C8C5C7] mb-8">You haven't started any property negotiations yet.</p>
